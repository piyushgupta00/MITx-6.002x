...
class Digraph(object):
    ...
    def __str__(self):
        ...
        for src_node in self.edges.keys():
            for dest_node in self.edges[src_node]:
                edge=WeightedEdge(src_node,dest_node[0],dest_node[1][0],dest_node[1][1])
    ...
    def add_edge(self, edge):
        ...
        self.edges[src].append([dest,((edge.get_total_distance()),\
...
#g.add_edge(e3)
#print(g)
##print(type((g.childrenOf(na))))
#print(nc in nodelist)
